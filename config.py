...
SECONDS_PER_HOUR = 12.0  # one full day = 4 minutes at 1x
...
# ──────────────────────────────────────────────────────────────────────────────
# Districts (used by procedural map generation)
# ──────────────────────────────────────────────────────────────────────────────

DISTRICT_LAYOUT = {
"downtown":     {"radius": 0.18, "wealth": 0.85},
"residential":  {"radius": 0.45, "wealth": 0.55},
"industrial":   {"radius": 0.70, "wealth": 0.35},
"slums":        {"radius": 1.00, "wealth": 0.15},
}
